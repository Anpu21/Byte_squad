...
-- Mirrors backend/src/migrations/1779730200000-CreateSalesReturns.ts.
...
CREATE INDEX "IDX_sales_returns_branch_created" ON "sales_returns" ("branch_id", "created_at");
CREATE INDEX "IDX_sales_returns_sale" ON "sales_returns" ("sale_id");
CREATE INDEX "IDX_sales_returns_invoice" ON "sales_returns" ("invoice_number");
