...
import { CreateTransactionDto } from '@/modules/pos-sales/dto/create-transaction.dto.js';
...
// Re-export so existing consumers that imported these from '@/modules/pos-sales/pos.service'
// keep working without a broad rename. New code should import from '@/modules/pos-sales/types'.
export type {
  DailyBreakdown,
  TopProduct,
  AdminDashboardData,
