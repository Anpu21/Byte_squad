...
import type { CreditTransaction } from '@/modules/pos-sales/entities/credit-transaction.entity';
import type { ActorPayload } from '@/modules/pos-sales/pos-write.service';
