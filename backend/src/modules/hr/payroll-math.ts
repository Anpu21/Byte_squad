import type { Attendance } from '@/modules/hr/entities/attendance.entity';
import type { Employee } from '@/modules/hr/entities/employee.entity';
import type { Payroll } from '@/modules/hr/entities/payroll.entity';
import type { SalaryStructure } from '@/modules/hr/entities/salary-structure.entity';
