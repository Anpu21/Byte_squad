...
import {
  EmployeesRepository,
  type EmployeeStatus,
} from '@/modules/hr/employees.repository';
import { Employee } from '@/modules/hr/entities/employee.entity';
import { CreateEmployeeDto } from '@/modules/hr/dto/create-employee.dto';
import { UpdateEmployeeDto } from '@/modules/hr/dto/update-employee.dto';
import { ListEmployeesQueryDto } from '@/modules/hr/dto/list-employees-query.dto';
import { TerminateEmployeeDto } from '@/modules/hr/dto/terminate-employee.dto';
