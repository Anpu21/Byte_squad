...
This is adapted from Andrej Karpathy's LLM Council. He dispatches queries to multiple models, has them peer-review each other anonymously, then a chairman produces the final answer. We do the same thing inside Codex using sub-agents with different thinking lenses instead of different models.
...
**A. Scan the workspace for context.** The user's question is often just the tip of the iceberg. Their Codex setup likely contains files that would dramatically improve the council's output. Before framing, quickly scan for and read any relevant context files:

- `AGENTS.md` or `AGENTS.md` in the project root or workspace (business context, preferences, constraints)
...
**User:** "Council this: I'm thinking of building a $297 course on Codex for beginners. My audience is mostly non-technical solopreneurs. Is this the right move?"

**The Contrarian:** "The market is flooded with Codex courses right now. At $297, you're competing with free YouTube content. Your audience is non-technical, which means high support burden and refund risk. The people who would pay $297 are likely already past beginner level..."
...
**The Expansionist:** "Beginner Codex for solopreneurs is a massive underserved market. Everyone's teaching advanced stuff. If you nail the beginner angle, you own the entry point to this entire space. The $297 might be low. What if this became a $997 program with community access..."

**The Outsider:** "I don't know what Codex is. If I saw '$297 course on Codex for beginners,' I wouldn't know if this is for me. The name means nothing to someone outside your world. Your landing page needs to sell the outcome, not the tool..."
...
*Where the council agrees:* The beginner solopreneur angle has real demand, but the current framing (Codex course) is too tool-specific and won't resonate with non-technical buyers.
...
*Blind spots caught:* The Outsider's point that "Codex" means nothing to the target buyer is the single most important insight. Every advisor except the Outsider assumed the audience already knows what this is.
...
*One thing to do first:* Run a $97 live workshop called "How to automate your first business task with AI" to 50 people. Don't mention Codex in the title.
...
Methodology by [Andrej Karpathy](https://x.com/karpathy). Codex adaptation inspired by [@olelehmann](https://x.com/olelehmann). Published by [@tenfoldmarc](https://instagram.com/tenfoldmarc) — follow for daily AI automation builds.
