...
export function buildComparisonExport(
    ...
    const columns: ExportColumn<LeaderboardRow>[] = [
        ...
        {
            header: 'Transactions',
            key: 'entry.sales.transactionCount',
            align: 'right',
            footer: 'sum',
        },
        {
            header: 'AOV',
            key: 'entry.sales.avgTransactionValue',
            align: 'right',
            format: 'currency',
        },
        {
            header: 'Staff',
            key: 'entry.staff.staffCount',
            align: 'right',
        },
        {
            header: 'Rev / Staff',
            key: 'entry.staff.revenuePerStaff',
            align: 'right',
            format: 'currency',
        },
    ];
