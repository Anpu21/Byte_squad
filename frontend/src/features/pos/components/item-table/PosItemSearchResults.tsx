 ...
 * matching product with code, name, and both retail/wholesale prices —
 * whichever matches the active `priceLevel` is rendered as the prominent
 * primary number, the other as a subdued secondary line.
 *
        ...
        >
            {results.map((row) => {
                ...
                const secondaryLabel =
                    priceLevel === 'Retail' ? 'Wholesale' : 'Retail';
                const secondaryPrice =
                    priceLevel === 'Retail' ? row.wholesalePrice : row.retailPrice;
