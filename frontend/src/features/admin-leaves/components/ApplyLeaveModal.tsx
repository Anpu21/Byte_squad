    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="block space-y-1.5">
                ...
                <textarea
                    className="w-full min-h-[72px] px-3 py-2 bg-surface border border-border rounded-md text-[13px] text-text-1 outline-none focus:border-primary focus:ring-[3px] focus:ring-primary/20 transition-colors"
                    value={reason}
