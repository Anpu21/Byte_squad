    ...
    return (
        <div className="px-5 py-3 border-t border-border bg-surface">
            ...
            <textarea
                ...
                required
                aria-required={true}
                className="w-full px-3 py-2 bg-canvas border border-border rounded-md text-[13px] text-text-1 outline-none focus:border-focus focus:ring-[2px] focus:ring-primary/30 transition-all placeholder:text-text-3 resize-none"
            />
