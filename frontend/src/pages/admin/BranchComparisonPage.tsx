  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <BranchComparisonFilters
        ...
        lockedBranchIds={p.lockedBranchIds}
        isFetching={p.isFetching}
        isDebouncing={p.isDebouncing}
        dateError={p.dateError}
      />
      ...
      {!p.hasSelection && (
        <Card>
          <EmptyState
            ...
            description="Choose one or more branches. The dashboard refreshes automatically."
          />
        </Card>
      )}

      {p.hasSelection && !p.comparison && p.isLoading && <ResultsSkeleton />}
